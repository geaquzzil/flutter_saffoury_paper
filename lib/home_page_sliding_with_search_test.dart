...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _searchHeight = _initSearchHeight;
  }

  Widget getSearchBar(BuildContext context, ExampleItemPager pager) {
    return Positioned(
      bottom: _searchHeight,
      child: Column(
        ...
        SlidingUpPanel(
          ...
          onPanelSlide: (double pos) => {
            setState(() {
              ...
              _searchHeight = pos * (_panelHeightOpen - _panelHeightClosed) +
                  _initSearchHeight;
            })
          },
        ),
        // getSearchBar(context, pager),
        getSearchBar(context, pager),
      ],
    ));
    return Material(
