...
Employee _$EmployeeFromJson(Map<String, dynamic> json) => Employee()
  ...
  ..warehouse_employees = (json['warehouse_employees'] as List<dynamic>?)
      ?.map((e) => WarehouseEmployee.fromJson(e as Map<String, dynamic>))
      .toList();
...
Map<String, dynamic> _$EmployeeToJson(Employee instance) => <String, dynamic>{
      ...
      'warehouse_employees':
          instance.warehouse_employees?.map((e) => e.toJson()).toList(),
    };
