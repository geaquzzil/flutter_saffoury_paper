...
part of 'products_expected_to_buy.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProductsExcpectedToBuy _$ProductsExcpectedToBuyFromJson(
  Map<String, dynamic> json,
) =>
    ProductsExcpectedToBuy()
      ...
      ..barcode = intFromString(json['barcode'])
      ...
      ..pending_cut_requests =
          (json['pending_cut_requests'] as num?)?.toDouble()
      ..cut_request_quantity =
          (json['cut_request_quantity'] as num?)?.toDouble()
      ..products_types =
          json['products_types'] == null
              ? null
              : ProductType.fromJson(
                json['products_types'] as Map<String, dynamic>,
              )
      ...
      ..countries_manufactures =
          json['countries_manufactures'] == null
              ? null
      ...
      ..products_colors =
          json['products_colors'] == null
              ? null
              : ProductsColor.fromJson(
                json['products_colors'] as Map<String, dynamic>,
              )
      ..inventory =
      ...
      ..purchases_details =
          (json['purchases_details'] as List<dynamic>?)
              ?.map((e) => PurchasesDetails.fromJson(e as Map<String, dynamic>))
              .toList()
      ..purchases_details_count =
          (json['purchases_details_count'] as num?)?.toInt()
      ...
      ..reservation_invoice_details =
          (json['reservation_invoice_details'] as List<dynamic>?)
              ?.map(
                (e) => ReservationInvoiceDetails.fromJson(
...
Map<String, dynamic> _$ProductsExcpectedToBuyToJson(
  ProductsExcpectedToBuy instance,
) => <String, dynamic>{
  'iD': instance.iD,
