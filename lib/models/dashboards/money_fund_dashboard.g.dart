...
part of 'money_fund_dashboard.dart';
    ...
    MoneyFundDashbaord()
      ...
      ..modifiedCustomerToPayNext =
          (json['modifiedCustomerToPayNext'] as List<dynamic>?)
              ?.map((e) => CustomerTerms.fromJson(e as Map<String, dynamic>))
              .toList()
      ..overdue_reservation_invoice = (json['overdue_reservation_invoice']
              as List<dynamic>?)
          ?.map((e) => ReservationInvoice.fromJson(e as Map<String, dynamic>))
          .toList()
      ..pending_reservation_invoice = (json['pending_reservation_invoice']
              as List<dynamic>?)
          ?.map((e) => ReservationInvoice.fromJson(e as Map<String, dynamic>))
          .toList()
