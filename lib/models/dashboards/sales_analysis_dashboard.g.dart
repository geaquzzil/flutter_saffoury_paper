  ...
  Map<String, dynamic> json,
    ...
    SalesAnalysisDashboard()
      ...
      ..orders_offline_count =
          (json['orders_offline_count'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..orders_online_count =
          (json['orders_online_count'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..customers_count =
          (json['customers_count'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..products =
          (json['products'] as List<dynamic>?)
              ...
              .toList()
      ..totalSalesQuantity =
          (json['totalSalesQuantity'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..totalReturnsQuantity =
          (json['totalReturnsQuantity'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..totalNetSalesQuantity =
          (json['totalNetSalesQuantity'] as List<dynamic>?)
              ...
              .toList()
      ..totalSalesPrice =
          (json['totalSalesPrice'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..totalReturnsPrice =
          (json['totalReturnsPrice'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..totalNetSalesPrice =
          (json['totalNetSalesPrice'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..profitsByOrder =
          (json['profitsByOrder'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..profitsByCutRequests =
          (json['profitsByCutRequests'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..wastesByCutRequests =
          (json['wastesByCutRequests'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList()
      ..incomesDue =
          (json['incomesDue'] as List<dynamic>?)
              ?.map(
                (e) => AccountNamesBalance.fromJson(e as Map<String, dynamic>),
              )
              .toList()
      ..spendingsDue =
          (json['spendingsDue'] as List<dynamic>?)
              ...
              .toList()
      ..calculatedNetProfit =
          (json['calculatedNetProfit'] as List<dynamic>?)
              ?.map((e) => GrowthRate.fromJson(e as Map<String, dynamic>))
              .toList();
...
Map<String, dynamic> _$SalesAnalysisDashboardToJson(
  ...
  'customers_count': instance.customers_count?.map((e) => e.toJson()).toList(),
  ...
  'totalSalesPrice': instance.totalSalesPrice?.map((e) => e.toJson()).toList(),
  'totalReturnsPrice':
      instance.totalReturnsPrice?.map((e) => e.toJson()).toList(),
  'totalNetSalesPrice':
      instance.totalNetSalesPrice?.map((e) => e.toJson()).toList(),
  'profitsByOrder': instance.profitsByOrder?.map((e) => e.toJson()).toList(),
  'profitsByCutRequests':
