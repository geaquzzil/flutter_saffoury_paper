...
class BaseHomeSmallScreenLayout extends StatefulWidget {
  const BaseHomeSmallScreenLayout({Key? key}) : super(key: key);

  @override
  State<BaseHomeSmallScreenLayout> createState() =>
      _BaseHomeSmallScreenLayoutState();
}

class _BaseHomeSmallScreenLayoutState extends State<BaseHomeSmallScreenLayout> {
  bool _showFab = true;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: NotificationListener<UserScrollNotification>(
        ...
        child: SafeArea(child: ListApiSearchableWidgetTestScrolling()),
      ),
    );
  }
