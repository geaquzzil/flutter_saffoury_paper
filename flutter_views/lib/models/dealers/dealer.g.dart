...
Dealers _$DealersFromJson(Map<String, dynamic> json) =>
    Dealers()
...
Map<String, dynamic> _$DealersToJson(Dealers instance) => <String, dynamic>{
  ...
  'dealers_emails': instance.dealers_emails?.map((e) => e.toJson()).toList(),
  'dealers_emails_count': instance.dealers_emails_count,
  'dealers_phones': instance.dealers_phones?.map((e) => e.toJson()).toList(),
  'dealers_phones_count': instance.dealers_phones_count,
  'dealers_social': instance.dealers_social?.map((e) => e.toJson()).toList(),
